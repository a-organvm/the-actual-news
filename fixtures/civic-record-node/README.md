...
This directory contains the canonical civic story bundle for the Records Watch platform. The bundle represents a complete, replayable civic record that demonstrates the full verification spine: narrative, claims, evidence, corrections, and governance.
