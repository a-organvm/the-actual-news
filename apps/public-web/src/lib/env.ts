...
export const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL ?? "https://recordswatch.org";
export const SITE_TITLE = process.env.NEXT_PUBLIC_SITE_TITLE ?? "Records Watch";
export const SITE_DESCRIPTION =
  process.env.NEXT_PUBLIC_SITE_DESCRIPTION ??
  "Verifiable news ledger providing public claim graphs, evidence audits, and correction history for civic records.";
